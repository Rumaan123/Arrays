...
thirdfruit[2] = "25";
4; //change the second element of the numbers arrays to 25.
thirdfruit.push("grape");
5; //add the element grape to the end of the fruits arrays using the method.
...
lastfruit.unshift("kiwi");
8; //add the first element
fruits.splice(1, 2);
9; //remove 2 elements from the fruits arrays starting from index 1 using the method.
console.log(fruits);
fruits.splice(2, 0, 'pineapple', 'pear');
10; //insert the elements pineapple and pear at index 2 of the fruits arrays using the method.
console.log(fruits);
...
let citrusfruits = ["banana", "mango", "kiwi", "graps"];
...
let lasttwofruits = ["date", "elderberry", "apple", "mango", "watermalan"];
